...
urlpatterns = [
    ...
    path('add_noticias/', noticiasViews.add_noticias, name = 'add_noticias'),
    # path('update_noticias/', noticiasViews.update_noticias, name = 'update_noticias'),
    # path('delete_noticias/', noticiasViews.delete_noticias, name = 'delete_noticias'),
